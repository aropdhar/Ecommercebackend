...
const _ = Router();
const {categorycontroller,getallcategory,singlecategory,approvedcategory , deletecategory , updatecategory} = require('../../controller/category.controller.js')
...
_.route("/updatecategory/:id").put(updatecategory)
